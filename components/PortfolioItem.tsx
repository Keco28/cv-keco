...
function PortfolioItem({icon, title, description, link}: PortfolioItemProps) {
  ...
  return (
    <div className="flex flex-col gap-5 py-[20px] bg-white">
      <div className="flex w-[320px] h-[300px] justify-center place-items-center self-center">
      ...
      <div className='flex flex-col gap-2 px-7'>
          ...
          <a className="hover:underline" style={{fontWeight: 500, fontSize: 18, color: "#2D8F1D", cursor: "pointer" }} onClickCapture={handlePortfolioClick}>Learn More &gt;</a>
